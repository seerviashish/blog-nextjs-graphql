...
export const pageSlice = createSlice({
    ...
    reducers: {
        ...
        updateTitleAndMetaDescription: (state, action: PayloadAction<{
            title: string,
...
export const { updateTitle, updateMetaDescription, updateTitleSuffix, updateTitleAndMetaDescription } = pageSlice.actions;
...
export const selectMetaDescription = (state: RootState) => state.page.metaDescription;
